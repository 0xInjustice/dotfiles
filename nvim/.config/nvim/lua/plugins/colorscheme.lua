...
return {
	"retro-terminal", -- Just a name for this "plugin"
	dir = vim.fn.stdpath("config") .. "/colors", -- Point to where the file actually is if needed, or just use it as a dummy
	virtual = true, -- Or just make it a simple spec
	config = function()
		local colors = {
